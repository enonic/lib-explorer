	...
	<tbody>
		...
		return `<tr>
			...
			<td>
				...
				<a class="tiny compact ui button" href="${TOOL_PATH}/collections/collect/${name}" target="_blank"><i class="green cloud download icon"></i>Collect</a>
				<a class="tiny compact ui button" href="${TOOL_PATH}/collections/collect/${name}?resume=true" target="_blank"><i class="green redo alternate icon"></i>Resume</a>
